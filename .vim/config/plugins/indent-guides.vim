...
augroup indent-guides
  autocmd!
  autocmd VimEnter,Colorscheme * :highlight IndentGuidesOdd guibg=#F7F7F7 ctermbg=234
  autocmd VimEnter,Colorscheme * :highlight IndentGuidesEven guibg=#F1F1F1 ctermbg=235
augroup END
